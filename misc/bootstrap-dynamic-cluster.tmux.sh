...
join_cluster() {
	...
	then
		sleep 0.5
		tmux send-keys "sleep 2; ./target/debug/memstore --raft-addr=127.0.0.1:6006${PANEL_NUM} --web-server=127.0.0.1:800${PANEL_NUM} --peer-addr=127.0.0.1:60061 --ignore-static-bootstrap" C-m
	fi
}
